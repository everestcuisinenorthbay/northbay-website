      ...
      <div className="md:hidden flex flex-row h-auto">
        {image ? (
          <div className="relative w-1/3 overflow-hidden">
            <Image
              ...
              alt={name}
              fill
              wrapperClassName="relative aspect-square"
        ...
        <div className="w-2/3 p-4 flex flex-col relative">
          <div className="absolute top-2 right-2">
            <span className="text-[#5C4033] font-medium bg-[#FEFAE0] px-2 py-0.5 rounded transition-colors duration-500 ease-out group-hover:bg-[#FEFAE0]/80 font-sans">{price}</span>
          </div>
        ...
        {image ? (
          <div className="relative aspect-square w-full overflow-hidden">
            <Image
              ...
              alt={name}
              fill
              wrapperClassName="relative w-full h-48 md:h-56"
              className="object-cover transition-transform duration-700 ease-out group-hover:scale-[1.03]"
            />
