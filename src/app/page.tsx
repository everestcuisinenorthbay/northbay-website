  ...
  return (
    <main className="min-h-screen w-full font-sans">
      ...
      {/* Carousel - Positioned to bridge hero and about sections */}
        <motion.div 
        className="relative -mt-60 sm:-mt-72 md:-mt-80 md:max-lg:-mt-[32rem] lg:-mt-96 md:max-lg:pt-32 z-30 flex justify-center items-center mb-[-2rem] sm:mb-[-1rem] md:mb-[0] pointer-events-none pb-8 sm:pb-10 overflow-x-hidden"
