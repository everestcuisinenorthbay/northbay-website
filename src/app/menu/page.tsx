...
export default function MenuPage() {
  ...
  const [selectedLocation] = useState<'ottawa' | 'northbay'>('northbay');
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              ...
              <p className="text-white/95 font-sans max-w-2xl mx-auto text-lg">
                We offer more than just dining - explore our additional services. We also proudly serve a selection of alcoholic beverages to complement your meal.
              </p>
            </motion.div>
            ...
            >
              <span className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white/90 text-sm font-medium">
                ...
                Call us for catering or event inquiries:&nbsp; <strong>NB</strong>:&nbsp;705-495-2030
              </span>
            </motion.div>
          </div>
        </div>
